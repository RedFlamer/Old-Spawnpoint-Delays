...
local has_old_spawngroups = table.find_all_values(all_spawngroups, function(group)
...
local path = Old_Spawnpoint_Delays.mod_path .. "maps/" .. level .. ".lua"
